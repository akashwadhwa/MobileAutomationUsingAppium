Feature: Create an account for new user
      ...
      @Amazon
 		Scenario Outline: 10004_Searching a product and add to cart for Valid Login Credentials
    ...
    @Amazon
 		Scenario Outline: 10005_Searching a product and Add to cart for Invalid Login Credentials
    Given Read the test data  "<TestData>" from Excel file
    When Navigate to the url
		And Click on Account and Lists
		And Enter the login credentials
