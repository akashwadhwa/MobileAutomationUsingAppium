...
public class AndriodConstants {
	...
	public static class Cloudfm {
		...
		public static final String btn_nextatTimesheet = "	//android.view.View[@content-desc='']";
		...
		public static final String btn_Agenda_home = "//android.view.View[@content-desc='Agenda']";
		...
		public static final String input_uname_webview_name = ".//*[@text='Mobile Number Mobile']";
